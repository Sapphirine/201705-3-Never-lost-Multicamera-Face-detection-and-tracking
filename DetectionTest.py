...
if __name__ == '__main__':
    ...
    #PNet = DeepLearningModel(caffeModelP, deployFileP, meanFile, gpu=True)
    #RNet = DeepLearningModel(caffeModelR, deployFileR, meanFile, gpu=True)
    #ONet = DeepLearningModel(caffeModelO, deployFileO, meanFile, gpu=True)
    ...
    cap = skvideo.io.VideoCapture('uploads/tbbt.avi', (640, 480))
